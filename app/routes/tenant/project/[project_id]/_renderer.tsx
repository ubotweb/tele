                ...
                <aside className="w-full md:w-64 flex-shrink-0">
                    <div className="bg-white dark:bg-darkcard rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden sticky top-24">
                        ...
                        <nav className="flex flex-col p-4 space-y-1">
                            ...
                            <a href={`/tenant/project/${projectId}/users`} className="flex items-center gap-3 px-4 py-3 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-colors">
