    ...
    return (
        <Layout title={title || (projectId ? 'Project Workspace' : 'Tenant Dashboard')}>
            <div className="flex flex-col md:flex-row gap-6 relative min-h-screen">
                        ...
                        <nav className="flex flex-col p-4 space-y-1">
                            {!projectId ? (
                                ...
                                <>
                                    ...
                                    <a href={`/tenant/project/${projectId}/bot`} className="flex items-center gap-3 px-4 py-3 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition-colors"><span className="font-medium text-sm">Token</span></a>
                ...
                {/* KONTEN UTAMA (Dengan padding bawah agar tidak tertutup nav mobile) */}
                ...
                {/* STICKY BOTTOM NAV KHUSUS MOBILE */}
                <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white/90 dark:bg-darkcard/90 backdrop-blur-md border-t border-gray-200 dark:border-gray-800 flex justify-around items-center p-3 z-50 pb-safe">
                    {!projectId ? (
                        <>
            ...
            <script dangerouslySetInnerHTML={{ __html: `
                // Mengisolasi scope variabel agar tidak bentrok dengan halaman anak
                {
                ...
                // Attach fungsi ke window agar bisa dipanggil HTML secara global
