...
export default createRoute((c) => {
    return c.render(
        <main className="flex-grow flex flex-col items-center justify-center text-center px-4 py-16 w-full">
            ...
            <div id="features" className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8 text-left max-w-5xl mx-auto">
